...
chunk_valid = pd.read_csv(DATA_PATH, chunksize=chunksize, skiprows=660000, nrows=220000, header=None, dtype=dt) # 220000
chunk_test = pd.read_csv(DATA_PATH, chunksize=chunksize, skiprows=880000, nrows=220000, header=None, dtype=dt) # 220000
